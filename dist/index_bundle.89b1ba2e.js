...
},{}],"js/convert_value.js":[function(require,module,exports) {
var convertValute = function convertValute(value, valuteNominal, valuteValue) {
  var converted = (value * valuteNominal / valuteValue).toFixed(2);
...
},{}],"js/index_bundle.js":[function(require,module,exports) {
...
var _require = require('../js/convert_value'),
    convertValute = _require.convertValute;
...
function createOptions() {
  return _createOptions.apply(this, arguments);
}
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return getValuteData();

          case 2:
            valute = _context.sent;
            request = indexedDB.open('valutes', 1);
            ...
            request.onupgradeneeded = function (e) {
              ...
              var objectStore = valuteDb.createObjectStore('valutes', {
                keyPath: 'Name'
              });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index_bundle.js"], null)
//# sourceMappingURL=/index_bundle.89b1ba2e.js.map